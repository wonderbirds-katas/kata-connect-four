...
namespace Kata.Logic.Tests
{
    public class AscendingDiagonalCoordinateSystemTest
    {
        ...
        {
            Assert.Equal(expected, new AscendingDiagonalCoordinateSystem().MaximumVerticalPosition(diagonal));
        }
        ...
        {
            Assert.Equal(expected, new AscendingDiagonalCoordinateSystem().GetCartesianRow(diagonal, position));
        }
        ...
        {
            Assert.Equal(expected, new AscendingDiagonalCoordinateSystem().GetCartesianColumn(diagonal, position));
        }
    }
}